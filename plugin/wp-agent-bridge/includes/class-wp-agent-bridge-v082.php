...
final class WP_Agent_Bridge_V082
{
    ...
    public static function block_legacy_option_actions($result, WP_REST_Server $server, WP_REST_Request $request)
    {
        ...
        return new WP_REST_Response([
            'code' => 'wpab_legacy_option_action_disabled',
            'message' => 'Legacy option.get/option.update are disabled. Use the protected option.safe.* actions through /wpab-v08/v1/manage.',
