...
final class TakKa_WordPress_Bridge_Post_Concurrency_Runtime_Guidance
{
    ...
    private const OPTION_SIGNATURE = 'takka_bridge_post_concurrency_guidance_signature_v1';
    private const TRANSIENT_LOCK = 'takka_bridge_post_concurrency_guidance_lock_v1';
    ...
    public static function sync()
    {
        ...
        $capabilities = TakKa_WordPress_Bridge_Direct_GitHub::get_text_file(
            $token,
            $repository,
            $branch,
        ...
        $agents = TakKa_WordPress_Bridge_Direct_GitHub::get_text_file(
            $token,
            $repository,
            $branch,
            self::AGENTS_PATH
