...
final class WP_Agent_Bridge_V06_Self_Update
{
    ...
    private const BOOTSTRAP = 'wp-agent-bridge.php';
    ...
    {
        $bootstrap = @file_get_contents(self::root() . '/' . self::BOOTSTRAP);
