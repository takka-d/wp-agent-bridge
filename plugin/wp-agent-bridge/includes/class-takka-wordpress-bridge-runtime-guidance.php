...
final class TakKa_WordPress_Bridge_Runtime_Guidance
{
    ...
    public static function agents(string $repository, string $branch, string $host, string $version): string
    {
        return "# WP Agent Bridge runtime — CANONICAL\n\n"
            ...
            . "- Core post fields/status/featured image: `post.get` and `post.update` through the operation router.\n"
            . "- Small local/conversation media up to 1 MiB decoded: one `media.upload.inline` operation. Do not stage/split/verify-first unless inline upload actually fails.\n"
            ...
            . "- Two or more independent reads: one `readonly.batch`.\n"
    ...
    public static function runtime(string $repository, string $branch, string $host, string $version): string
    {
        return "# WP Agent Bridge Direct Runtime\n\n"
            ...
            . "Machine-readable routing contract: `wordpress-bridge/RUNTIME_CAPABILITIES.json`. Common operations use `/takka-v099/v1/operate`.\n\n"
