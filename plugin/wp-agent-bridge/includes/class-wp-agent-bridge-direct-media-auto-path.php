 ...
 */
final class WP_Agent_Bridge_Direct_Media_Auto_Path
{
    ...
    {
        return (bool) preg_match('/^wpab_direct_github_http_(404|405|501)$/', $error->get_error_code());
    }
    ...
    {
        $blob = WP_Agent_Bridge_Direct_GitHub::github_api(
            'GET',
