 ...
 */
final class WP_Agent_Bridge_V096_Media_Hook
{
    ...
    public static function after_upload($response, array $handler, WP_REST_Request $request)
    {
        ...
        $site_icon = WP_Agent_Bridge_V096_Site::set_uploaded_attachment((int) $data['id'], $json);
        ...
        if (class_exists('WP_Agent_Bridge_V07_Audit')) {
