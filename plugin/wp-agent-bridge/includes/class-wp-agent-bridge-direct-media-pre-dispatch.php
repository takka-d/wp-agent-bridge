 ...
 */
final class WP_Agent_Bridge_Direct_Media_Pre_Dispatch
{
    ...
    public static function init(): void
    {
        remove_filter(
            ...
            [WP_Agent_Bridge_Direct_Media_Auto_Path::class, 'maybe_upload'],
            self::OLD_PRIORITY
        );
    ...
    {
        return WP_Agent_Bridge_Direct_Media_Auto_Path::maybe_upload($result, [], $request);
    }
}
