 ...
 */
final class WP_Agent_Bridge_Post_Content_Diagnostics
{
    private const V084_ROUTE = '/wpab-v084/v1/manage';
    ...
    public static function enrich_conflict($response, array $handler, WP_REST_Request $request)
    {
        ...
        if ($response->get_error_code() !== 'wpab_post_content_match_count') {
            return $response;
        }
