...
require_once __DIR__ . '/includes/class-takka-wordpress-bridge-v06-self-update-source.php';
...
require_once __DIR__ . '/includes/class-takka-wordpress-bridge-v094-diagnostics.php';
require_once __DIR__ . '/includes/class-takka-wordpress-bridge-v095-outline.php';
require_once __DIR__ . '/includes/class-takka-wordpress-bridge-v095-html.php';
require_once __DIR__ . '/includes/class-takka-wordpress-bridge-v095-classic.php';
require_once __DIR__ . '/includes/class-takka-wordpress-bridge-v095-compat.php';
require_once __DIR__ . '/includes/class-takka-wordpress-bridge-v096-site.php';
require_once __DIR__ . '/includes/class-takka-wordpress-bridge-v096-media-hook.php';
require_once __DIR__ . '/includes/class-takka-wordpress-bridge-v096-theme-files.php';
...
require_once __DIR__ . '/includes/class-takka-wordpress-bridge-uploads-json.php';
...
require_once __DIR__ . '/includes/class-takka-wordpress-bridge-direct-invalid-pending.php';
...
TakKa_WordPress_Bridge_V094_Diagnostics::init();
