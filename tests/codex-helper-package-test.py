...
ZIP = ROOT / "downloads" / "wp-agent-bridge-helper-0.2.0.zip"
...
if manifest.get("name") != "wp-agent-bridge-helper" or manifest.get("version") != "0.2.0":
...
if compat.get("name") != "wp-agent-bridge-helper" or compat.get("version") != "0.2.0":
