...
class WP_Agent_Bridge_Direct_Runtime {
...
class WP_Agent_Bridge_Direct_GitHub {
    public static bool $valid = true;
    public static function verify_webhook(string $raw, string $signature): bool { return self::$valid; }
}

require __DIR__ . '/../plugin/wp-agent-bridge/includes/class-wp-agent-bridge-direct-webhook-loop-guard.php';
...
function req(array $commits, array $repo = []): WP_REST_Request {
    ...
    return new WP_REST_Request('POST', WP_Agent_Bridge_Direct_Runtime::WEBHOOK_ROUTE, [
        'x-github-event' => 'push',
...
$r = WP_Agent_Bridge_Direct_Webhook_Loop_Guard::pre_dispatch(null, $server, req([
...
WP_Agent_Bridge_Direct_GitHub::$valid = false;
$r = WP_Agent_Bridge_Direct_Webhook_Loop_Guard::pre_dispatch(null, $server, req([
    ['added' => ['wordpress-bridge/media/pending/a.b64'], 'modified' => [], 'removed' => []],
]));
